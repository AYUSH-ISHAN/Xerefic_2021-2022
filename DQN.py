...
for episode in tqdm(range(1, EPISODES+1), ascii='True', unit='episodes'):
        ...
        current_state_A = env.reset()
        current_state_B = env.reset()
        ...
        while not done:
           ...
           # new_state, reward, done, _ = env.step(action)
            rewardA, rewardB, done, new_info = env.step()
            ...
            agentA.update_memory([current_info, action, rewardA, rewardB, new_info, done])
